...
class InsigniasVisitantePagina extends StatefulWidget {
  final int idUsuarioVisitante;

  const InsigniasVisitantePagina({super.key, required this.idUsuarioVisitante});

  @override
  State<InsigniasVisitantePagina> createState() => _InsigniasVisitantePaginaState();
}

class _InsigniasVisitantePaginaState extends State<InsigniasVisitantePagina> {
  ...
  Future<void> _cargarInsigniasDesbloqueadas() async {
    ...
    await insigniaProvider.obtenerInsigniasDesbloqueadasUsuario(idUsuarioVisitante, 1); //compras
    //print("Insignias compra: ${insigniaProvider.insigniasCompra.length}");
    await insigniaProvider.obtenerInsigniasDesbloqueadasUsuario(idUsuarioVisitante, 2); //ventas
    //print("Insignias venta: ${insigniaProvider.insigniasVenta.length}");
    await insigniaProvider.obtenerInsigniasDesbloqueadasUsuario(idUsuarioVisitante, 3); //recursos educativos
