...
class BurbujaMensaje extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        if (!esMio) // Mostrar el avatar solo para mensajes del receptor
          CircleAvatar(
            radius: 18,
            backgroundImage: avatarUrl != null ? NetworkImage(avatarUrl!) : null,
            child: avatarUrl == null
        ...
        const SizedBox(width: 8), // Espaciado entre el avatar y el mensaje
        Align(
          ...
          child: Container(
            ...
            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
            decoration: BoxDecoration(
              color: esMio ? Theme.of(context).colorScheme.surface : Theme.of(context).colorScheme.secondaryContainer,
              borderRadius: BorderRadius.circular(20),
              boxShadow: [
                BoxShadow(
                  color: Colors.black.withOpacity(0.05),
