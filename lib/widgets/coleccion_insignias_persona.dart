...
class ColeccionInsigniasPersona extends StatelessWidget {
  final String nombreColeccion;
  final List<InsigniaDesbloqueada> insignias;
  final int tipoContador;
  final int valorContador;

  const ColeccionInsigniasPersona({
    super.key,
  ...
  Widget _buildInsignia(InsigniaDesbloqueada insignia, BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        Image.network(
